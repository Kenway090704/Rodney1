...
public final class DownloadProvider extends ContentProvider {
    /** Database filename */
    public static final String DB_NAME = "app_downloads.db";
     ...
     * {@link AppDownloadManager#getUriForDownloadedFile(long)} if the given downloaded file
     * is publicly accessible.
     */
    private static final int PUBLIC_DOWNLOAD_ID = 6;
    

	static String AUTHORITIES=Downloads.Impl.AUTHORITIES;
    ...
    private static final List<String> downloadManagerColumnsList =
            Arrays.asList(AppDownloadManager.UNDERLYING_COLUMNS);
    ...
    public boolean onCreate() {
        ...
        // start the AppDownloadService class. don't wait for the 1st download to be issued.
        // saves us by getting some initialization code in AppDownloadService out of the way.
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
         ...
         * AppDownloadManager.addCompletedDownload(String, String, String,
        ...
        // public api requests and networktypes
        if (isPublicApi) {
        ...
        String Test = filteredValues.get(Downloads.Impl.COLUMN_TOTAL_BYTES).toString();
        ...
        if (values.getAsInteger(Downloads.Impl.COLUMN_DESTINATION) ==
                Downloads.Impl.DESTINATION_NON_DOWNLOADMANAGER_DOWNLOAD) {
            // don't start AppDownloadService because it has nothing to do in this case.
...
//        } else {
  ...
  //      }
	...
	//liujw edit NotiExtra and NotiClass
    ...
    public Cursor query(final Uri uri, String[] projection,
             ...
             final String sort) {
Log.v("www", "selectionselection="+selection);
    ...
    public int update(final Uri uri, final ContentValues values,
        ...
        if (values.containsKey(Downloads.Impl.COLUMN_DELETED)) {
            if (values.getAsInteger(Downloads.Impl.COLUMN_DELETED) == 1) {
                // some rows are to be 'deleted'. need to start AppDownloadService.
                startService = true;
            }
        }
        ...
        if (Binder.getCallingPid() != Process.myPid()) {
		    ...
		    //liujw pause or continue download  2012-3-5-23
