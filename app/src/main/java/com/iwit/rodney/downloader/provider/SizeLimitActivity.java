...
public class SizeLimitActivity extends Activity
    ...
    private void showDialog(Cursor cursor) {
        ...
        String queueText ="button_queue_for_wifi";
        boolean isWifiRequired =
            mCurrentIntent.getExtras().getBoolean(AppDownloadInfo.EXTRA_IS_WIFI_REQUIRED);

        AlertDialog.Builder builder = new AlertDialog.Builder(this, AlertDialog.THEME_HOLO_DARK);
        if (isWifiRequired) {
            builder.setTitle("wifi_required_title")
                    .setMessage("R.string.wifi_required_body"+sizeString +queueText)
            ...
            builder.setTitle("wifi_recommended_title")
                    .setMessage("wifi_recommended_body"+sizeString+queueText)
